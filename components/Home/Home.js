...
if(newlyAdded){  
  ...
  return (
    ...
    <Head>
        ...
        Buy and sell Jammu and Kashmir-registered cars on JKCarmart, a free platform connecting buyers and sellers directly, with no agents or hidden costs." />
      ...
      <div className="container">
        ...
        <div className={Styles.NewlyText}>
          <div className="sec-heading">
            <h2>Newly Added cars for sale</h2>
          </div>
...
<h2 className={`${Styles.JKcarmartWorks} text-lg font-semibold text-black`}>
How JKcarmart works
</h2>
</div>
</div>
...
3 steps to get your dream car directly from seller
    ...
    <section>
      <div className="container">
        <div className="sec-heading">
          <h2>Choose cars from popular body types</h2>
        </div>

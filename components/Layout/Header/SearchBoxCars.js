...
return(
  <> 
    <DataList value={savedCarSearchValues} placeholder="Search your car" items={carBrandModelsList} onSearch={showCars} itemClass=" datalist_input_car_search_item" />
    {/* {savedCarSearchValues && <button className="clear_search" onClick={clearSearch}>Clear</button>} */}
    </>
)
}
export default SearchBoxCars;
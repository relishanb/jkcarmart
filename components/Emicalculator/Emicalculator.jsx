...
const EmiCalculator = ({ setShowModal, showModal, defaultLoanAmount }) => {
  ...
  return (
    <div className="flex flex-col rounded-lg bg-gray-900 text-white lg:h-full px-4 py-4 w-full lg:w-[740px] overflow-y-auto z-10">
      {/* Left Section */}

...
<CarInfoDetailed id={route.query.id} carInfo={carInfo} lightBoxDetails={lightBoxDetails} />
...
export async function getServerSideProps({ req, res }) { 
  const clickedCarDetails = JSON.parse(getCookie("clickedCarDetails", { req, res }));
